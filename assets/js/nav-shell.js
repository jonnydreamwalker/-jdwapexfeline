(function () {
  ...
  var CART_KEY = SITE.cartKey || "jdw_feline_cart";
  ...
  window.startSquarePayment = function () { alert("Square — wire via ApexFreePort."); };
  window.startStripePayment = function () { alert("Stripe — wire via ApexFreePort."); };
})();
